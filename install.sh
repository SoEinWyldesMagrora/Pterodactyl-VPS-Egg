...
display_menu() {
    ...
    printf "${colors[GREEN]}┃                                                                             ┃${colors[NC]}\n"
    printf "${colors[GREEN]}┃                           ${colors[PURPLE]} ixnixdevs${colors[GREEN]}                             ┃${colors[NC]}\n"
    printf "${colors[GREEN]}┃                                                                             ┃${colors[NC]}\n"
    printf "${colors[GREEN]}┃                          ${colors[RED]}© 2023 - $(date +%Y) ${colors[PURPLE]}@ixnixdevs${colors[GREEN]}                            ┃${colors[NC]}\n"
    printf "${colors[GREEN]}┃                                                                             ┃${colors[NC]}\n"
    printf "${colors[GREEN]}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${colors[NC]}\n"
